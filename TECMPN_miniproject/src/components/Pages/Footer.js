...
const Footer = () => {
  return (
    <>
    <footer className="p-4 divide-y bg-gray-800 text-gray-100 sm:fixed sm:bottom-[6%] md:relative w-auto align-baseline">
    <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
      <div className="lg:w-1/3 mr-4">
        <a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
          ...
          <span className="self-center text-2xl font-semibold"> Orphanage Foundation Center </span>
        </a>
      </div>
      <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
        ...
        <div className="space-y-3">
          ...
          <div className="flex justify-start space-x-3">
            <a rel="noopener noreferrer" href="https://instagram.com/atharvaahirekar?utm_medium=copy_link" title="Facebook" className="flex items-center p-1">
            ...
            <a rel="noopener noreferrer" href="https://instagram.com/atharvaahirekar?utm_medium=copy_link" title="Twitter" className="flex items-center p-1">
            ...
            <a rel="noopener noreferrer" href="https://instagram.com/atharvaahirekar?utm_medium=copy_link" title="Instagram" className="flex items-center p-1">
